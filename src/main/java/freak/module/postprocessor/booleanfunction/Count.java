...
public class Count extends AbstractPostprocessor {
	...
	// �bergebe valueBitSet des Literals und f�hre And darauf aus. Wenn erstes Literal, dann �bergebe 1 Bitstring
...
//			System.out.println("erf�llt "+fulfilledCases+" F�lle und "+fulfilledControls+" Kontrollen.");
