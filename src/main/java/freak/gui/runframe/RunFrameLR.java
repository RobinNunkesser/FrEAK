 ...
 */
public class RunFrameLR extends RunFrameUI implements StateListener {
...
// Actions ***********************************************************************
	...
	private void newClicked() {
		...
		scheduleEditor = new ScheduleEditor(RunFrameLR.this, null);
	...
	private void editClicked() {
		...
		scheduleEditor = new ScheduleEditor(RunFrameLR.this, runControl.getSchedule());
		scheduleEditor.setVisible(true);
		modeEdit();
...
// FEEDBACK ********************************************************************
	...
	public void simulationException(final Exception exc) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				JOptionPane.showMessageDialog(RunFrameLR.this, exc, "Exception in Simulation", JOptionPane.ERROR_MESSAGE);
			}
		});
		exc.printStackTrace();
	}
...
// HELP ************************************************************************
	...
	public void aboutClicked() {
		AboutDialog d = new AboutDialog(RunFrameLR.this, true);
		d.setLocationRelativeTo(RunFrameLR.this);
		d.setVisible(true);
	}
		...
		public void actionPerformed(ActionEvent evt) {
			if (activeView != null) {
				...
				if (view instanceof Configurable) {
					PropertyDialog pd = new PropertyDialog(RunFrameLR.this, runControl.getSchedule().getEventController(), activeView.getView(), null, runControl.getSchedule().getBatchList());
					pd.setVisible(true);
					runControl.scheduleEdited(runControl.getSchedule());
					activeView.revalidate();
					activeView.repaint();
				} else {
					JOptionPane.showMessageDialog(RunFrameLR.this, "Selected view is not configurable.", "Error", JOptionPane.ERROR_MESSAGE);
				}
			} else {
				JOptionPane.showMessageDialog(RunFrameLR.this, "No view selected.", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
